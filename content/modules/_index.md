...
Un **isomorfismo** es un homomorfismo biyectivo. Un **automorfismo** es un isomorfismo de un $R$-módulo en sí mismo.
{{% /definition %}}
...
tales que $f$ es sobreyectivo e $\operatorname{im} A=\ker f$. Esto, en virtud del primer [teorema](#isomodules) de isomorfía, equivale a dar una matriz $A$ y un isomorfismo
...
está también generada por sus columnas. Claramente, para generar $\operatorname{im} D$ bastan las primeras $k$ columnas de $D$, que además son linealmente independientes, por tanto forman una base
...
Por el primer [teorema](#isomodules) de isomorfía,
$$
